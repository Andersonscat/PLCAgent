...
class ProjectController(ConfigTreeNode, PLCControler):
    ...
    # "label" is the short caption shown next to the icon on the Status
    # toolbar; "group" drives the separators between logical clusters
    # (run / deploy / debug) so the toolbar reads as grouped actions
    # instead of an undifferentiated row of icons.
    StatusMethods = [
        {
            "bitmap":    "Build",
            "name":    _("Build"),
        ...
        },
        {
            ...
            "label":   _("Run"),
            "group":   "run",
            "tooltip": _("Start PLC simulation (local runtime)"),
            "method":   "_Run",
            "shown":      True,
        },
        {
            ...
            "label":   _("Stop"),
            "group":   "run",
            "tooltip": _("Stop the running PLC"),
            "method":   "_Stop",
            "shown":      False,
        },
        {
        ...
        },
        {
            ...
            "label":   _("IEC code"),
            "group":   "debug",
            "tooltip": _("Show IEC 61131-3 code generated by PLCGenerator"),
            "method":   "_showIECcode",
            "shown":      False,
        },
        {
            "bitmap":    "tool_generate",
            "name":    _("Generate Program"),
            "label":   _("Generate"),
            "group":   "deploy",
            "tooltip": _("Compile and generate program for OpenPLC Runtime"),
        ...
        },
        {
            ...
            "label":   _("Upload"),
            "group":   "deploy",
            "tooltip": _("Compile and upload program to an Arduino-class PLC"),
        ...
        },
        {
            ...
            "label":   _("Debug"),
            "group":   "debug",
            "tooltip": _("Live-debug the running PLC (watch variables in real time)"),
            "method":   "_debugPLC",
            "shown":      True,
        },
    ]
